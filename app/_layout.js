    ...
    if (this.state.hasError) {
      return (
        <View style={styles.eb}>
          ...
          <TouchableOpacity style={styles.ebBtn} onPress={this.handleReload} activeOpacity={0.7}>
            <Text style={styles.ebBtnText}>Reload</Text>
          </TouchableOpacity>
        </View>
      );
    }
...
const styles = StyleSheet.create({
  ...
  ebMsg: { color: "#aaa", fontSize: 14, textAlign: "center", marginBottom: 20 },
  ebBtn: { backgroundColor: "#333", borderRadius: 8, paddingHorizontal: 24, paddingVertical: 10 },
  ebBtnText: { color: "#fff", fontSize: 15, fontWeight: "600" },
});
